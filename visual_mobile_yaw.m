...
figure(2);
plot(handle_P(:,1), mobile_P(:,4), 'b--o', 'MarkerSize',3, 'MarkerEdgeColor','black', 'MarkerFaceColor',[0 0 0]);
% plot(dist(:,1), mobile_P(:,4), 'b--o', 'MarkerSize',3, 'MarkerEdgeColor','black', 'MarkerFaceColor',[0 0 0]);
xlim([-0.1 1.6]);
% xlim([0 dist(i(1,1),1)]);
ylim([-180 180]);
...
figure(3);
plot(handle_P(:,1), selected_manipulability(:,1), 'r--o', 'MarkerSize',3, 'MarkerEdgeColor','black', 'MarkerFaceColor',[0 0 0]);
% plot(dist(:,1), selected_manipulability(:,1), 'r--o', 'MarkerSize',3, 'MarkerEdgeColor','black', 'MarkerFaceColor',[0 0 0]);
xlim([-0.1 1.6]);
% xlim([0 dist(i(1,1),1)]);
ylim([0 0.2]);
